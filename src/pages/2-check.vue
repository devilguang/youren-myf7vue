    ...
    <f7-page>
        ...
        <f7-list form>
            ...
            <f7-list-item>
                ...
                <f7-input name="unit" type="text" placeholder="上海交通大学" v-model="formValues.college"></f7-input>
            </f7-list-item>
            <f7-list-item>
                <f7-label floating>学位</f7-label>
                <f7-input name="degree" type="text" placeholder="博士" v-model="formValues.degree"></f7-input>
            </f7-list-item>
            <f7-list-item>
                <f7-label floating>职称</f7-label>
                <f7-input name="title" type="text" placeholder="教授" v-model="formValues.professionalTitle"></f7-input>
            </f7-list-item>
            <f7-list-item>
                <f7-label floating>研究方向</f7-label>
                <f7-input name="area" type="text" placeholder="材料科学" v-model="formValues.researchDirect"></f7-input>
            </f7-list-item>
        </f7-list>
